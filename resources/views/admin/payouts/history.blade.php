	...
	<div class="card-body">
		<div class="row">
			<div class="form-group col-sm-6 row">
		      	<label for="inputPassword" class="col-sm-4 col-form-label">Date Search</label>
		      	<div class="col-sm-8">
					<input type="text" class="form-control" id="inputPassword" placeholder="From date">
				</div>
			</div>
			<div class="form-group col-sm-6 row">
		      	<label for="inputPassword" class="col-sm-4 col-form-label">To</label>
		      	<div class="col-sm-8">
					<input type="text" class="form-control" id="inputPassword" placeholder="To date">
				</div>
			</div>
		</div>
		<div class="row">
